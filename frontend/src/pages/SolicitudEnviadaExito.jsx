  ...
  return (
    <div className="min-h-screen bg-white flex items-start justify-center">
      <div className="max-w-3xl w-full px-6 py-20">
        <h1 className="text-2xl md:text-3xl font-bold text-center text-[#2B6CB0] mb-12">┬íSolicitud enviada!</h1>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 mb-6">La solicitud se envi├│ correctamente. Pronto recibir├ís novedades sobre su estado.</p>

          <button
            onClick={() => navigate('/mis-solicitudes')}
            className="px-6 py-3 bg-[#0B57A6] text-white rounded-lg font-semibold w-64 hover:bg-[#084c8a]"
          >
            Ir a ΓÇ£Mis SolicitudesΓÇ¥
          </button>
        </div>
      </div>
    </div>
