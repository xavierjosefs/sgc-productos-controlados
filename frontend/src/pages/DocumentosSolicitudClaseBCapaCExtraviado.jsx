...
const DocumentosSolicitudClaseBCapaCExtraviado = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-center text-[#2B6CB0] mb-8">
          Solicitud de Certificado de Inscripción de Drogas Controladas Clase B para Hospitales Públicos y/u otras Instituciones Públicas
        </h1>
...
export default DocumentosSolicitudClaseBCapaCExtraviado;
