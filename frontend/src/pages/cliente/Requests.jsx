...
const Requests = () => {
  ...
  const { sortedData, SortableHeader } = useSortableTable(requests, { key: 'id', direction: 'desc' });
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#4A8BDF]">
                <th className="px-6 py-4 text-left text-white font-semibold text-sm"><SortableHeader columnKey="id">ID</SortableHeader></th>
                <th className="px-6 py-4 text-left text-white font-semibold text-sm"><SortableHeader columnKey="tipo_servicio">Tipo de Servicio</SortableHeader></th>
                <th className="px-6 py-4 text-left text-white font-semibold text-sm"><SortableHeader columnKey="estado_actual">Estado</SortableHeader></th>
                <th className="px-6 py-4 text-left text-white font-semibold text-sm"><SortableHeader columnKey="fecha_creacion">Fecha Creación</SortableHeader></th>
