...
const FIELD_LIST_RENOVACION = [
  ...
  { key: 'copiaPago', label: 'Copia del permiso de apertura y/o habilitación del establecimiento vigente, o copia del volante de renovación saldado por la Ventanilla Única de Servicios (solo si aplica)' },
];
