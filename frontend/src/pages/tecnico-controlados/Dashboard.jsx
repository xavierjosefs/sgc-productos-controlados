        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-[#4A8BDF]">Panel Técnico de Controlados</h1>
                        <p className="text-gray-600 mt-1">Bienvenido, {user?.full_name || 'Técnico'}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <span className="text-sm text-gray-600">Pendientes de Evaluación</span>
                ...
                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200">
                        <h2 className="text-lg font-semibold text-gray-800">Solicitudes Pendientes de Evaluación</h2>
                    </div>
                    <table className="w-full">
                        <thead>
                            <tr className="bg-[#4A8BDF]">
                                ...
                                <th className="px-6 py-4 text-left text-white font-semibold text-sm">Prioridad</th>
                                <th className="px-6 py-4 text-left text-white font-semibold text-sm">Fecha Recepción</th>
                        ...
                        <tbody>
                            <tr>
                                <td colSpan="6" className="px-6 py-12 text-center text-gray-500">
                                    No hay solicitudes pendientes de evaluación
                                </td>
                            </tr>
                        </tbody>
                    </table>
