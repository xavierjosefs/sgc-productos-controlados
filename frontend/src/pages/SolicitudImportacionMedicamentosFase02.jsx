...
export default function SolicitudImportacionMedicamentosFase02() {
  ...
  const todosDocumentosCargados = DOCUMENTOS_FASE_02.every(doc => documentos[doc.key]);
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const resp = await createRequest({
        nombre_servicio: 'Solicitud de Permiso de Importación de Medicamentos con Sustancia Controlada - Fase 02',
        formulario: { fase: 2 }
      });
      ...
      // Subir documentos de fase 2
      for (const doc of DOCUMENTOS_FASE_02) {
