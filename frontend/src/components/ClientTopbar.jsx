        ...
        <div className="flex-1 flex justify-center">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-5 py-2 rounded-lg font-semibold text-sm transition-colors ${location.pathname.startsWith('/requests') || location.pathname === '/cliente' ? 'bg-[#085297] text-white' : 'bg-gray-100 text-[#085297] hover:bg-[#D5E8F7]'}`}
            >
              Solicitudes
            </button>
            <button
              onClick={() => navigate('/support')}
              className={`px-5 py-2 rounded-lg font-semibold text-sm transition-colors ${location.pathname === '/support' ? 'bg-[#085297] text-white' : 'bg-gray-100 text-[#085297] hover:bg-[#D5E8F7]'}`}
            >
              Soporte
            </button>
          </div>
