...
export default function TecnicoTopbar() {
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <p className="text-sm font-medium text-gray-900">{user?.full_name || 'Técnico'}</p>
                <p className="text-xs text-gray-500">Técnico de Controlados</p>
              </div>
            </div>
            <button
